...
set <- read.table("household_power_consumption.txt", header = TRUE, sep=";", nrow = ne-ns, skip=ns-1, col.names=columnnames, stringsAsFactors=FALSE)

# construct the plot and save it to a PNG file with a width of 480 pixels and a height of 480 pixels
png(filename="plot4.png", width = 480, height = 480, units = "px", bg = "transparent") # not sure if the background was white or transparent
